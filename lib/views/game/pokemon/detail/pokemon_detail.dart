        ...
        bottom: Padding(
          ...
          child: SizedBox(
            ...
            child: CustomButton(
              text: '카운터 등록',
              onTap: () {
                PokemonDetailController.instance.insertPokemonCounter();
              },
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        GestureDetector(
                          onTap: () {
                            PokemonDetailController.instance.goToPrev();
                          },
                          child: SvgPicture.asset(
                        ...
                        Expanded(
                          child: Image.network(
                            PokemonDetailController.instance.getImage(),
                            height: 167,
                          ),
                        ),
                        GestureDetector(
                          onTap: () {
                            PokemonDetailController.instance.goToNext();
                          },
                          child: SvgPicture.asset(
                    ...
                    Row(
                      ...
                      children: [
                        PokemonDetailController.instance.info.firstType != null
                            ? PokemonTypeChip(
                              type:
                        ...
                        PokemonDetailController.instance.info.secondType != null
                            ? Padding(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 5),
                            Text(
                              PokemonDetailController.instance.info.description,
                              style: TextStyle(
                                color: ColorStyle.white,
                                fontSize: 16,
                              ),
