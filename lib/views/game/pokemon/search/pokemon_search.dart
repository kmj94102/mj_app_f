            ...
            TextField(
              decoration: InputDecoration(
                ...
                enabledBorder: OutlineInputBorder(
                  ...
                  borderSide: BorderSide(color: ColorStyle.white, width: 0),
                ),
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        GestureDetector(
                          onTap: () {
                            PokemonSearchController.instance.updateIsAll(true);
                          },
                          child: SelectChip(
                            text: '전체',
                            isSelect: PokemonSearchController.instance.isAll,
                          ),
                        ),
                        SizedBox(width: 10),
                        ...
                        GestureDetector(
                          onTap: () {
                            PokemonSearchController.instance.updateIsAll(false);
                          },
                          child: SelectChip(
                            text: '안 잡은 포켓몬 만',
                            isSelect: !PokemonSearchController.instance.isAll,
                    ...
                    Wrap(
                      ...
                      children: List.generate(
                        ...
                        (index) => GestureDetector(
                          onTap: () {
                            PokemonSearchController.instance.updateSelectType(
                              index,
                            );
                          },
                          child: SelectChip(
